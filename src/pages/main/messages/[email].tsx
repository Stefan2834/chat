               ...
               {err === "User don't exist" ? (
                  ...
                  <>
                     ...
                     {info ? (
                        ...
                        <>
                           <div className='w-full bg relative overflow-auto flex items-center justify-start flex-col-reverse py-2 pl-10 h-full mobile:fixed mobile:bottom-16 mobile:h-[calc(100%-120px)]'
